...
class LabelManager:
    def __init__(self, width, height, time, num_questions):
        ...
        self.top_label = pyglet.text.Label(text = "Question 1", color = colors.ORANGE, font_name = 'Calibri', font_size = 48,
        ...
        self.score_label = pyglet.text.Label(text = "0 / " + str(num_questions), color = colors.ORANGE, font_name = 'Calibri', font_size = 36,
